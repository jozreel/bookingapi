...
class simplecontroler {
  ...
  exponentialBackoff(func, max,attempts)
  { 
    
    console.log(attempts, Math.pow(2,attempts));
    return new Promise((Resolve, Reject)=>{
        ...
        func().then(res=>{
          ...
          if(max > 0)
          {
            let nextTry  =Math.floor((Math.pow(2,attempts)-1)/2);
            setTimeout(()=>{
              this.exponentialBackoff(func, --max, ++attempts);
            }, nextTry)
          }
          else{
            Reject("we give up")
